# CLAUDE.md — Calculator5329

**AI & full-stack builder in Rochester, MN** **Software Engineer @ Dovaxis** · **AI/ML Master's Student @ WGU**

Workspace conventions apply (`~/projects/CLAUDE.md`, `~/projects/WORKSPACE.md`).

## Verify before committing

_No automated verify command detected — verify manually and add one to this file when the repo gains tests or a build._
